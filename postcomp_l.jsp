...
<meta http-equiv="Content-Language" content="en-gb">
 <link rel="File-List" href="postcomp_l_files/filelist.xml">
...
<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse; position: absolute; left: 0; top: 0; border-left-width:0; border-top-width:0; border-bottom-width:0" bordercolor="#30A1DB" width="781" id="AutoNumber1" height="900">
  <tr>
    ...
    <area href="faq.jsp" shape="rect" coords="286, 141, 324, 152">
    <area href="index.jsp" shape="rect" coords="625, 97, 658, 109">
    <area href="contact.jsp" shape="rect" coords="365, 139, 434, 154">
    </map>
    <img border="0" src="JPG/UpperMenu_1.jpg" width="780" height="208" usemap="#FPMap0"></span><form>
      ...
      <table border="0" cellspacing="1" style="border-collapse: collapse; position: absolute; left: 126; top: 852" bordercolor="#111111" width="649" height="50">
        <tr>
 ...
 <v:textpath style='font-family:"Impact";v-text-kern:t' trim="t" fitpath="t"
  xscale="f" string="Posted Complaints"/>
</v:shape><![endif]--><![if !vml]><img border=0 width=520 height=73
src="postcomp_l_files/image001.gif" alt="E-AUCTION Search Engine" v:shapes="_x0000_s1028"><![endif]></td>
            </tr>
          </table>
          <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; position: absolute; left: 1; top: 173" bordercolor="#111111" width="593" id="AutoNumber12" height="506">
            <tr>
              <td width="100%" valign="top">
              <form method="POST">
                <p><textarea readonly="readonly" rows="29" name="S1" cols="71">
                <%
                try{
connect a6=new connect();
ResultSet b6=a6.getcon().executeQuery("select * from Complaint order by Complaint.co_id");
while(b6.next())
{
%>
posted by: <%=b6.getString(2) %> <%=b6.getString(3) %>
Subject : <%=b6.getString(4) %>
Posted Date: <%=b6.getString(6) %>
Description : <%=b6.getString(5) %>
...
%>        
  ...
  <p><span style="position: absolute; left: 0; top: 209">
    ...
    <area href=javascript:customize2() shape="rect" coords="25, 35, 113, 50">
    ...
    <img border="0" src="JPG/logleft.jpg" width="187" height="175" usemap="#FPMap1"></span></p>
...
{
%>
<jsp:forward page="postcomp.jsp"></jsp:forward>
<%
}
%>