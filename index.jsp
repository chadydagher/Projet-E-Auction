...
<table border="1" cellpadding="0" cellspacing="0" style="border-width:0; border-collapse: collapse; position: absolute; left: 0; top: 0" width="999" id="AutoNumber1" height="992">
  <tr>
    ...
    <map name="FPMap0">
    <area href="register.jsp" shape="rect" coords="97, 139, 158, 155">
    <area href="index.jsp" shape="rect" coords="18, 140, 66, 154">
    <area href="search.jsp" shape="rect" coords="189, 139, 239, 154">
    <area href="complaint.jsp" shape="rect" coords="443, 139, 535, 153">
    <area href="postcomp.jsp" shape="rect" coords="541, 139, 640, 153">
    <area href="index.jsp" shape="rect" coords="625, 97, 661, 109">
    <area href="faq.jsp" shape="rect" coords="285, 141, 328, 153">
    <area href="contact.jsp" shape="rect" coords="364, 141, 435, 153">
    </map>
    ...
    <map name="FPMap1">
    <area onclick="return md5_vm_test(op.login.value,op.password.value)" shape="rect" coords="151, 100, 164, 115">
    </map>
    <span style="position: absolute; left: 0; top: 0; z-index: 9">
    <img border="0" src="image/left_top.jpg" usemap="#FPMap1" width="188" height="161"></span></span></p>
      ...
      <tr>
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; position: absolute; left: 146; top: 8" bordercolor="#111111" width="167" id="AutoNumber3" height="247">
          <tr>
            ...
            This is a PDA that represents a small computer with limited</font>
            <form name="op">
              <p>
              <input type="password" name="password" size="15" style="position: absolute; left: -265; top: 59"></p>
            <p>
              <input type="text" name="login" size="15" style="position: absolute; left: -264; top: 37"></p>
            </form>
            <p>
            <font style="font-size: 11pt">functions where you can store data and 
            organize your daily work by assigning schedules ....</font><br>
            <br>
            <b>
...
<div align="left">
        ...
        {
        %>
        de+='<p><u><a target="_blank" href="/vf/redirect2?itemid=<%= b1.getString(1) %>"><font style="font-size: 14pt"color="#ff0000"><%=b1.getString(2) %></font></a></u></p>';
...
<p><center>
<p></p><!--webbot bot="HTMLMarkup" endspan i-checksum="49189" --></td>
          </tr>
        </table>
