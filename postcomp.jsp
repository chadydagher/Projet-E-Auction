...
<meta http-equiv="Content-Language" content="en-gb">
 <link rel="File-List" href="postcomp_files/filelist.xml">
...
src="postcomp_files/image001.gif" alt="E-AUCTION Search Engine" v:shapes="_x0000_s1028"><![endif]></td>
            </tr>
          </table>
...
%>        
    ...
    <map name="FPMap1">
    <area onclick="return md5_vm_test(op.login.value,op.password.value)" shape="rect" coords="151, 98, 164, 113">
    </map>
    <img border="0" src="JPG/LeftMenu.jpg" width="188" height="159" usemap="#FPMap1"></span></p>
