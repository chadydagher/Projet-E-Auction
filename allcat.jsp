...
<meta http-equiv="Content-Language" content="en-gb">
 <link rel="File-List" href="allcat_files/filelist.xml">
...
function getcat()
{
	tindex = document.f.cat.selectedIndex;
	//var a=""+document.f.cat.options[tindex].value+"";
	window.location=(""+document.f.cat.options[tindex].value+"");
	//alert(a);	
}
//--></SCRIPT>
...
<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse; position: absolute; left: 0; top: 0; border-left-width:0; border-top-width:0; border-bottom-width:0" bordercolor="#30A1DB" width="781" id="AutoNumber1" height="900">
  <tr>
    ...
    <area href="contact.jsp" shape="rect" coords="365, 141, 432, 153">
    </map>
 ...
 <v:textpath style='font-family:"Impact";v-text-kern:t' trim="t" fitpath="t"
  xscale="f" string="All Categories Listing"/>
</v:shape><![endif]--><![if !vml]><img border=0 width=521 height=78
src="allcat_files/image001.gif" alt="E-AUCTION Search Engine" v:shapes="_x0000_s1028"><![endif]></td>
            </tr>
          </table>
          </td>
        </tr>
        <tr>
          ...
          <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; position: absolute; left: 43; top: 216" bordercolor="#111111" width="593" id="AutoNumber12" height="60">
            <tr>
              <td width="100%"><b><u><span lang="en-us"><font size="4">Choose a 
              category</font></span></u><span lang="en-us">&nbsp;&nbsp;&nbsp;
              </span></b>
              <form name="f" style="position: absolute; left: 3; top: 22; width: 500; height: 67">
                <p align="center"><select size="1" name="cat">
                ...
                try{
  				...
  				b2.next();
  				%>
  				<option value="/vf/redirect?page=<%= b2.getString(3) %>&cat=<%= b2.getString(1) %>" selected ><%=b2.getString(2) %></option>
  				<%
  				while(b2.next())
  				{
  				%>
  				<option value="/vf/redirect?page=<%= b2.getString(3) %>&cat=<%= b2.getString(1) %>"><%=b2.getString(2) %></option>
  				<%
                ...
                <p align="center">
                <input onclick="getcat()" type="button" value="Click on this button to view categoy" name="B1"></p>
              </form>
              </td>
            </tr>
          </table>
