...
<link rel="File-List" href="bid_files/filelist.xml">
...
if (CDay < 0 ) {CDay = "0"; CHour = "0"; CMinute = "0"; CSecond = "0";DayTill="0";alert("this window will close because Bidding time has finished.");window.close();} //Stop at 0
else{
...
<table border="0" cellspacing="0" width="491" cellpadding="0" style="position: absolute; left: 0; top: 0" id="AutoNumber1" background="JPG/fon01.gif" height="238">
  <tr>
 ...
 style='width:213.75pt;height:51.75pt' adj="5665">
 <v:shadow color="#868686"/>
 <v:textpath style='font-family:"Impact";v-text-kern:t' trim="t" fitpath="t"
  xscale="f" string="Add new Bid"/>
</v:shape><![endif]--><![if !vml]><img border=0 width=288 height=72
src="bid_files/image001.gif" alt="Add new Bid" v:shapes="_x0000_s1025"><![endif]>
<form method="POST" action="probid.jsp">
     <p align="center">&nbsp;</p>
      <p align="center">Bid Amount: <input type="text" name="bid" size="20"></p>
      <p align="center"><input type="submit" value="Submit Bid" name="B1"></p>
    </form>
    </td>
  </tr>
</table>
