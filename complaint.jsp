...
<meta http-equiv="Content-Language" content="en-gb">
 <link rel="File-List" href="complaint_files/filelist.xml">
...
function md5_vm_test(ema,ema1)
{
  ...
  window.location="redirect3?usern="+(ema)+"&upass="+hex_md5(ema1)+"";
...
<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse; position: absolute; left: 0; top: 0; border-left-width:0; border-top-width:0; border-bottom-width:0" bordercolor="#30A1DB" width="781" id="AutoNumber1" height="900">
  <tr>
    ...
    <area href="complaint.jsp" shape="rect" coords="443, 139, 534, 154">
    <area href="postcomp.jsp" shape="rect" coords="543, 140, 639, 154">
    <area href="faq.jsp" shape="rect" coords="283, 140, 327, 154">
    <area href="index.jsp" shape="rect" coords="626, 97, 655, 108">
    <area href="contact.jsp" shape="rect" coords="361, 140, 432, 153">
    </map>
 ...
 <v:textpath style='font-family:"Impact";v-text-kern:t' trim="t" fitpath="t"
  xscale="f" string="Post Complaint"/>
</v:shape><![endif]--><![if !vml]><img border=0 width=520 height=73
src="complaint_files/image001.gif" alt="E-AUCTION Search Engine" v:shapes="_x0000_s1028"><![endif]></td>
            </tr>
          </table>
          <form method="get" action="procom.jsp">
          </form>
          </form>
          </td>
        </tr>
        <tr>
          ...
          <table border="3" cellpadding="0" cellspacing="0" style="border-collapse: collapse; position: absolute; left: 93; top: 218" bordercolor="#111111" width="358" id="AutoNumber12" height="298">
            <tr>
              <td width="100%" valign="top">
              <address>
                <span lang="en-us">&nbsp;</span></address>
              <address>
                <span lang="en-us" style="font-style: normal; font-weight: 700">&nbsp;First 
                Name</span></address>
              <address>
&nbsp;</address>
              <address>
                <span lang="en-us"><b><span style="font-style: normal">&nbsp;Last 
                Name</span></b></span></address>
              <address>
&nbsp;</address>
              <address>
                <span lang="en-us"><b><span style="font-style: normal">&nbsp;Complaint 
                Title</span></b></span></address>
              <address>
&nbsp;</address>
              <address>
                <span lang="en-us"><b><span style="font-style: normal">&nbsp;Complait 
                Description</span></b></span></address>
              <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; position: absolute; left: 80; top: 13" bordercolor="#111111" width="358" id="AutoNumber13">
                <tr>
                  <td width="100%">
                  <form  method="GET" action="procom.jsp">
                    <p align="center">
                    <input type="text" name="fname" size="24"></p>
                    <p align="center"><input type="text" name="lname" size="24"></p>
                    <p align="center">
                    <input type="text" name="cotitle" size="24"></p>
                    <p align="center">
                    <textarea rows="6" name="codesc" cols="20"></textarea></p>
                    <p align="center">
                    <input type="submit" value="Submit Complaint" name="B1" style="float: left"></p>
                  </form>
                  <p>&nbsp;</td>
                </tr>
              </table>
    ...
    <map name="FPMap1">
    <area onclick="return md5_vm_test(op.login.value,op.password.value)" shape="rect" coords="151, 99, 164, 114">
    </map>
    <img border="0" src="JPG/LeftMenu.jpg" width="188" height="160" usemap="#FPMap1"></span></p>
