...
<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse; position: absolute; left: 0; top: 0; border-left-width:0; border-top-width:0; border-bottom-width:0" bordercolor="#30A1DB" width="781" id="AutoNumber1" height="900">
  <tr>
    ...
    <area href="postcomp.jsp" shape="rect" coords="541, 141, 638, 154">
    <area href="index.jsp" shape="rect" coords="625, 98, 658, 108">
    <area href="index.jsp" shape="rect" coords="285, 140, 326, 153">
    <area href="contact.jsp" shape="rect" coords="363, 140, 432, 154">
    </map>
 ...
 <v:textpath style='font-family:"Impact";v-text-kern:t' trim="t" fitpath="t"
  xscale="f" string="E-AUCTION Search Engine"/>
</v:shape><![endif]--><![if !vml]><img border=0 width=520 height=72
src="search_files/image001.gif" alt="E-AUCTION Search Engine" v:shapes="_x0000_s1028"><![endif]></td>
            </tr>
          </table>
          <p>&nbsp;</td>
        </tr>
        <tr>
          ...
          <table border="3" cellpadding="0" cellspacing="0" style="border-collapse: collapse; position: absolute; left: 89; top: 207" bordercolor="#111111" width="374" id="AutoNumber12" height="188" bgcolor="#FFFFFF">
            <tr>
              <td width="100%" valign="top">
              <address>
                <span style="font-style: normal" lang="en-us">&nbsp;</span></address>
              <address>
              <form name="iope" method="get" action="search_r.jsp">
                <span style="font-style: normal" lang="en-us">&nbsp;<font face="Times New Roman"><b>Enter Search 
                Criteria&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </b></font>
                </span><b><font face="Times New Roman"><input type="text" name="crit" size="20"><span lang="en-us">&nbsp;
                </span>
                </font></b>
              </address>
              <address>
                <font face="Times New Roman">
                <span lang="en-us" style="font-style: normal; font-weight: 700">&nbsp;</span></font></address>
              <address>
                <font face="Times New Roman">
                <span lang="en-us" style="font-style: normal; font-weight: 700">&nbsp;Item 
                type&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <select size="1" name="type">
                <option name="type" Selected>All Types</option>
                <option name="type">Direct Sell Items</option>
                <option name="type">Bidding Items</option>
                </select></span></font></address>
              <address>
                <font face="Times New Roman">
                <span style="font-style: normal; font-weight:700" lang="en-us">&nbsp;</span></font></address>
              <address>
                <span lang="en-us"><span style="font-style: normal">
                <font face="Times New Roman"><b>Select 
                a category&nbsp;</b></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </span><select size="1" name="categ" style="text-align: left">
                <option name="categ" selected>All Categories</option>
                <%
                try{
  				connect a2=new connect();int count=0;
  				ResultSet b2=a2.getcon().executeQuery("select * from Category");
  				while(b2.next())
  				{
  				%>
  				<option name="categ"><%=b2.getString(2) %></option>
  				<%
  				count++;
  				}
  				a2.concl();
              ...
              <address>
                <span lang="en-us">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="submit" value="Submit Search" name="B1"></span></address>
              </td>
            </tr></form>
          </table>
          </td>
